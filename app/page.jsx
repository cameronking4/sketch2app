...
const flutterApp = `import 'package:flutter/material.dart';
...
export const upload2 = async (persona, base64_img) => {
  const res = await axios.post(
    "https://api.openai.com/v1/chat/completions",
    {
      model: "gpt-4-vision-preview",
      messages: [
        {
          role: "system",
          content: `You are an expert flutter developer. Create a full fledged mobile screen using flutter for the sketch provided. It is your job to generate the screen logic and UI. Populate this basic app: ${flutterApp}`,
        },
        {
          role: "user",
          content: [
        ...
        {
          role: "user",
          content: `Please return only the code.`,
        },
