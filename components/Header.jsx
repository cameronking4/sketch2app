...
import { getUserByUid } from "../app/actions";
...
export default async function Header() {
  ...
  if (uid) {
    currentUser = await getUserByUid(uid);
  }
  ...
  return (
    <>
      ...
      <div className="px-10 relative isolate hidden md:flex items-center gap-x-6 overflow-hidden bg-slate-50 py-2.5 sm:before:flex-1">
        <div>
          <div
